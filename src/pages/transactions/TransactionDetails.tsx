    ...
    <div id="main-container" className="flex flex-1">
      ...
      <div id="Content" className="flex flex-col flex-1 p-6 pt-0">
        <div id="Top-Bar" className="flex items-center w-full gap-6 mt-[30px] mb-6">
          <div className="flex items-center gap-6 h-[92px] bg-white w-full rounded-3xl p-[18px]">
            <div className="flex flex-col gap-[6px] w-full">
              ...
              <Link to={"/transactions"} className="flex items-center gap-[6px] text-monday-gray font-semibold">
        ...
        <main className="flex flex-col gap-6 flex-1">
          <section id="Merchant-Info" className="flex items-center justify-between rounded-3xl p-[18px] gap-3 bg-white">
          ...
          <section id="Products" className="flex flex-col gap-6 rounded-3xl p-[18px] px-0">
                ...
                {transaction.transaction_products.map((item) => (
                  <div className="card flex flex-col w-full rounded-3xl border border-monday-border p-4 gap-5">
                    <div className="flex items-center justify-between gap-6">
                      <div className="flex items-center gap-3 w-[316px] shrink-0">
                        <div className="flex size-[86px] rounded-2xl bg-monday-background items-center justify-center overflow-hidden">
                          <img src={item.product.thumbnail} className="size-full object-contain" alt="icon" />
                        </div>
                        <div className="flex flex-col gap-2 flex-1">
                          <p className="font-semibold text-xl w-[218px] truncate">{item.product.name}</p>
                    ...
                    <div className="flex w-full items-center justify-between">
                      ...
                      <p className="subtotal font-semibold text-xl text-monday-blue">Rp {item.sub_total.toLocaleString("id")}</p>
                    </div>
                  </div>
                ))}
              </div>
                ...
                <div className="flex flex-col w-full h-fit rounded-3xl p-[18px] gap-5 bg-white">
                  ...
                  <div className="flex flex-col gap-5">
                    ...
                    <div className="flex flex-col w-full items-center justify-between gap-5 rounded-2xl border border-monday-border p-4">
                      <div className="flex w-full items-center justify-between">
                        <p className="flex items-center gap-1 font-medium text-monday-gray">
                          <img src="/assets/images/icons/shopping-cart-grey.svg" className="size-6 flex shrink-0" alt="icon" />
                      ...
                      <div className="flex w-full items-center justify-between">
                        <p className="flex items-center gap-1 font-medium text-monday-gray">
                          <img src="/assets/images/icons/box-grey.svg" className="size-6 flex shrink-0" alt="icon" />
                      ...
                      <div className="flex w-full items-center justify-between">
                        <p className="flex items-center gap-1 font-medium text-monday-gray">
                          <img src="/assets/images/icons/receipt-2-grey.svg" className="size-6 flex shrink-0" alt="icon" />
                          <span>Subtotal</span>
                        </p>
                      ...
                      <div className="flex w-full items-center justify-between">
                        <p className="flex items-center gap-1 font-medium text-monday-gray">
                          <img src="/assets/images/icons/note-text-grey.svg" className="size-6 flex shrink-0" alt="icon" />
                          <span>PPN 10%</span>
                        </p>
                      ...
                      <div className="flex w-full items-center justify-between">
                        <p className="flex items-center gap-1 font-medium text-monday-gray">
                          <img src="/assets/images/icons/moneys-grey.svg" className="size-6 flex shrink-0" alt="icon" />
                          <span>Grand Total</span>
                        </p>
                        <p className="font-semibold text-xl text-monday-blue">Rp {transaction.grand_total.toLocaleString("id")}</p>
                      </div>
                    </div>
                  </div>
                </div>
