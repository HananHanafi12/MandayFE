...
const MyMerchantProfile = () => {
  ...
  if (isError) {
    return <p className="p-8 text-red-500">Failed to load merchant: {error.message}</p>;
  }
      ...
      <div id="main-container" className="flex flex-1">
        ...
        <div id="Content" className="flex flex-col flex-1 p-6 pt-0">
          ...
          <main className="flex flex-col gap-6 flex-1">
            <section id="Warehouse-Info" className="flex items-center justify-between rounded-3xl p-[18px] gap-3 bg-white">
              ...
              <div className="flex flex-col gap-2 flex-1">
                <p className="flex items-center gap-1 font-medium text-monday-gray">
                  <img src="assets/images/icons/user-grey.svg" className="size-4 flex shrink-0" alt="icon" />
              ...
              <div id="Header" className="flex items-center justify-between px-[18px]">
                <div className="flex flex-col gap-[6px]">
                  <p className="flex items-center gap-[6px]">
                    <img src="assets/images/icons/buildings-2-black.svg" className="size-6 flex shrink-0" alt="icon" />
                    <span className="font-semibold text-2xl">{merchant.products.length} Total Products</span>
                  </p>
                  <p className="font-semibold text-lg text-monday-gray">View and update your Product Warehouses list here.</p>
                </div>
              </div>
                      ...
                      <React.Fragment key={product.id}>
                        <div className="card flex items-center justify-between gap-6">
                          <div className="flex items-center gap-3 w-[340px] shrink-0">
                            ...
                            <div className="flex flex-col gap-2 flex-1">
                              <p className="font-semibold text-xl w-[242px] truncate">{product.name}</p>
                              <p className="font-semibold text-xl text-monday-blue">Rp {product.price.toLocaleString("id")}</p>
                            </div>
                          </div>
                          <div className="flex items-center gap-[6px] w-[187px] shrink-0">
                            ...
                            <p className="font-semibold text-lg text-nowrap w-[124px] truncate">{product.pivot?.stock} Stock</p>
                          </div>
                          <div className="flex items-center gap-[6px] w-[187px] shrink-0">
        ...
        <div className="modal flex flex-1 items-center justify-center h-full fixed top-0 w-full">
          ...
          <div className="relative flex flex-col w-[406px] shrink-0 rounded-3xl p-[18px] gap-5 bg-white">
            <div className="modal-header flex items-center justify-between">
              ...
              <button onClick={() => setSelectedProductId(null)} className="flex size-14 rounded-full items-center justify-center bg-monday-gray-background">
